...
"builtin.module"() ({
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.br"(%101, %100)[^bb1] <{loop_annotation = #loop_annotation}> : (i32, i32) -> ()
  ^bb3:  // pred: ^bb1
    "llvm.return"(%97) : (i32) -> ()
  }) : () -> ()
  ...
  ^bb2:  // pred: ^bb1
    ...
    "llvm.br"(%94, %93)[^bb1] <{loop_annotation = #loop_annotation}> : (i32, i32) -> ()
  ^bb3:  // pred: ^bb1
    "llvm.return"(%90) : (i32) -> ()
  }) : () -> ()
  ...
  ^bb9:  // pred: ^bb8
    ...
    "llvm.br"(%17, %16)[^bb8] <{loop_annotation = #loop_annotation}> : (i32, i32) -> ()
  ^bb10:  // pred: ^bb8
  ...
  ^bb16:  // pred: ^bb15
    ...
    "llvm.br"(%62)[^bb14] <{loop_annotation = #loop_annotation}> : (i32) -> ()
  ^bb17:  // pred: ^bb14
    "llvm.br"()[^bb18] : () -> ()
  ^bb18:  // pred: ^bb17
    %63 = "llvm.add"(%19, %2) <{overflowFlags = 1 : i32}> : (i32, i32) -> i32
    "llvm.br"(%63)[^bb12] <{loop_annotation = #loop_annotation}> : (i32) -> ()
  ^bb19:  // pred: ^bb12
  ...
  ^bb26:  // pred: ^bb25
    ...
    "llvm.br"(%68, %72, %64, %73)[^bb7] <{loop_annotation = #loop_annotation}> : (i32, i32, i32, i32) -> ()
  ^bb27:  // pred: ^bb10
    "llvm.return"() : () -> ()
  }) : () -> ()
