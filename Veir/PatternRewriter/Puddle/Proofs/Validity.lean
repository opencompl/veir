...
theorem RuntimeValue.conforms_integerType_iff (runtimeValue : RuntimeValue)
  ...
  constructor
  · exact RuntimeValue.Conforms.integerType.mp
  · rintro ⟨value, rfl⟩
...
macro "puddle_simp" "[" rule:ident "]" : tactic =>
  `(tactic| (
    ...
    all_goals intros
    all_goals try simp_all [InterpretsTo, TypeAttr.of, Coe.coe,
      TypeMatcher.accepts_integerType, RuntimeValue.Conforms.integerType,
