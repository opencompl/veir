...
buffed
def Sim.OpOperandPtr.removeFromCurrent!Sim (ctx: Sim.IRContext OpInfo) (operandPtr: Sim.OpOperandPtr) : Sim.IRContext OpInfo :=
...
theorem Sim.OpOperandPtr.removeFromCurrent!_eq_removeFromCurrent
  ...
  simp [Sim.OpOperandPtr.removeFromCurrent_def, Sim.OpOperandPtr.removeFromCurrentSim, removeFromCurrent!_def, removeFromCurrent!Sim]
  grind
...
theorem Sim.OpOperandPtr.removeFromCurrent_veir_inBounds (ptr : Veir.GenericPtr) :
  ...
  simp [eq_bang, removeFromCurrent!_def, removeFromCurrent!Sim]; grind
...
buffed
def Sim.OpOperandPtr.insertIntoCurrent!Sim (ctx : IRContext OpInfo) (operandPtr : OpOperandPtr) : IRContext OpInfo :=
...
theorem Sim.OpOperandPtr.insertIntoCurrent!_eq_insertIntoCurrent
  ...
  simp [insertIntoCurrent_def, insertIntoCurrent!_def, insertIntoCurrent!Sim, insertIntoCurrentSim]
  grind
...
buffed
def Sim.BlockOperandPtr.removeFromCurrent!Sim (ctx : Sim.IRContext OpInfo) (operandPtr : Sim.BlockOperandPtr) :
...
theorem Sim.BlockOperandPtr.removeFromCurrent!_eq_removeFromCurrent
    ...
    (operandIn : operandPtr.InBounds ctx) (ctxIn : ctx.spec.FieldsInBounds) :
    removeFromCurrent! ctx operandPtr = operandPtr.removeFromCurrent ctx operandIn ctxIn := by
  simp [Sim.BlockOperandPtr.removeFromCurrent_def, Sim.BlockOperandPtr.removeFromCurrentSim, removeFromCurrent!_def, removeFromCurrent!Sim]
  grind
...
buffed
def Sim.BlockOperandPtr.insertIntoCurrent!Sim (ctx : Sim.IRContext OpInfo) (operandPtr : Sim.BlockOperandPtr) : Sim.IRContext OpInfo :=
...
theorem Sim.BlockOperandPtr.insertIntoCurrent!_eq_insertIntoCurrent
    ...
    (operandIn : operandPtr.InBounds ctx) (ctxIn : ctx.spec.FieldsInBounds) :
    insertIntoCurrent! ctx operandPtr = operandPtr.insertIntoCurrent ctx operandIn ctxIn := by
  simp [insertIntoCurrent_def, insertIntoCurrent!_def, insertIntoCurrentSim, insertIntoCurrent!Sim]
  grind
...
buffed
def Sim.OperationPtr.linkBetween!Sim (self : Sim.OperationPtr) (ctx : Sim.IRContext OpInfo)
...
theorem Sim.OperationPtr.linkBetween!_eq_linkBetween {self : Sim.OperationPtr}
  ...
  simp [Sim.OperationPtr.linkBetween_def, Sim.OperationPtr.linkBetweenSim, linkBetween!_def, linkBetween!Sim]
  grind
...
buffed
def Sim.OperationPtr.setParentWithCheck!Sim (self : Sim.OperationPtr) (ctx : Sim.IRContext OpInfo) (parent : Sim.BlockPtr) :
...
theorem Sim.OperationPtr.setParentWithCheck!_eq_setParentWithCheck {self : Sim.OperationPtr} (selfIn : self.InBounds ctx) parentIb :
  ...
  simp [Sim.OperationPtr.setParentWithCheck_def, Sim.OperationPtr.setParentWithCheckSim, setParentWithCheck!_def, setParentWithCheck!Sim]
  grind
...
theorem Sim.OperationPtr.setParentWithCheck_inBounds (ptr : GenericPtr)
  ...
  simp [eq_bang, setParentWithCheck!_def, setParentWithCheck!Sim] at heq ⊢
  grind
...
buffed --(inline := false)
def Sim.OperationPtr.linkBetweenWithParent!Sim (self : Sim.OperationPtr) (ctx : Sim.IRContext OpInfo)
    (prevOp : Sim.OptionOperationPtr) (nextOp : Sim.OptionOperationPtr)
...
theorem Sim.OperationPtr.linkBetweenWithParent!_eq_linkBetweenWithParent
  ...
  simp [Sim.OperationPtr.linkBetweenWithParent_def, Sim.OperationPtr.linkBetweenWithParentSim, linkBetweenWithParent!_def, linkBetweenWithParent!Sim]
  grind
...
buffed
def Sim.BlockPtr.linkBetween!Sim (self : Sim.BlockPtr) (ctx : Sim.IRContext OpInfo)
...
theorem Sim.BlockPtr.linkBetween!_eq_linkBetween {self : Sim.BlockPtr}
  ...
  simp [Sim.BlockPtr.linkBetween_def, Sim.BlockPtr.linkBetweenSim, linkBetween!_def, linkBetween!Sim]
  grind
...
buffed
def Sim.BlockPtr.setParentWithCheck!Sim (self : Sim.BlockPtr) (ctx : Sim.IRContext OpInfo) (parent : Sim.RegionPtr) :
    Option (Sim.IRContext OpInfo) :=
  match (self.getParent! ctx).toOption with
  | some _ => none
  | none => self.setParent! ctx parent.toO
...
theorem Sim.BlockPtr.setParentWithCheck!_eq_setParentWithCheck {self : Sim.BlockPtr} (selfIn : self.InBounds ctx) :
  ...
  simp [Sim.BlockPtr.setParentWithCheck_def, Sim.BlockPtr.setParentWithCheckSim, setParentWithCheck!_def, setParentWithCheck!Sim]
  grind
...
buffed
def Sim.BlockPtr.linkBetweenWithParent!Sim (self : Sim.BlockPtr) (ctx : Sim.IRContext OpInfo)
...
theorem Sim.BlockPtr.linkBetweenWithParent!_eq_linkBetweenWithParent
  ...
  simp [Sim.BlockPtr.linkBetweenWithParent_def, Sim.BlockPtr.linkBetweenWithParentSim, linkBetweenWithParent!_def, linkBetweenWithParent!Sim]
  grind
...
theorem Sim.BlockPtr.linkBetweenWithParent_veir_inBounds (ptr : Veir.GenericPtr)
    ...
    ptr.InBounds newCtx.spec ↔ ptr.InBounds ctx.spec := by
  simp [eq_bang, linkBetweenWithParent!_def, linkBetweenWithParent!Sim] at heq ⊢
  grind [generic_ptr_grind]
