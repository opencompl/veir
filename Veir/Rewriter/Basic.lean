...
@[irreducible]
def Rewriter.createEmptyOp (ctx : IRContext opInfo) (opType : opInfo) (properties : OpInfo.propertiesOf opType) :
...
def Rewriter.createOp (ctx: IRContext opInfo) (opType: opInfo)
    ...
    (regions: Array RegionPtr) (properties: OpInfo.propertiesOf opType)
