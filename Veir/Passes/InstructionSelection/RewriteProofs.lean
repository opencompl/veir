...
axiom bitcast_local_preservesSemantics
    ...
    LocalRewritePattern.PreservesSemantics bitcast_local h h₂ h₃ h₄

axiom getelementptr_local_preservesSemantics
    ...
    LocalRewritePattern.PreservesSemantics getelementptr_local h h₂ h₃ h₄
...
axiom ssubSat_local_preservesSemantics
    {h : LocalRewritePattern.ReturnOps ssubSat_local}
    {h₂ : LocalRewritePattern.ReturnCtxChanges ssubSat_local}
    {h₃ : LocalRewritePattern.ReturnValuesInBounds ssubSat_local}
    {h₄ : LocalRewritePattern.ReturnValues ssubSat_local} :
    LocalRewritePattern.PreservesSemantics ssubSat_local h h₂ h₃ h₄

axiom sshlSat_local_preservesSemantics
    {h : LocalRewritePattern.ReturnOps sshlSat_local}
    {h₂ : LocalRewritePattern.ReturnCtxChanges sshlSat_local}
    {h₃ : LocalRewritePattern.ReturnValuesInBounds sshlSat_local}
    {h₄ : LocalRewritePattern.ReturnValues sshlSat_local} :
    LocalRewritePattern.PreservesSemantics sshlSat_local h h₂ h₃ h₄
