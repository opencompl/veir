...
/-!
  ...
  The data lemmas bridge the pattern's `matchSignedPow2Divisor` output (a `Nat` exponent `k` and a
  sign flag) and the emitted immediates (`BitVec.ofInt 6`/`5` of `w-1`, `w-k`, `k`) to the
  `Data.RISCV.sdivPow2*_refinement` lemmas in `InstructionSelection/Proofs.lean`, which are stated
  with a `BitVec` shift amount. `sdivPow2GenLocal_preservesSemantics` then lifts them to the graph
  level once, for both instances.
-/
...
theorem ofInt_6_sub (k : Nat) (hk : k ≤ 63) :
    BitVec.ofInt 6 ((64 : Int) - (k : Int)) = 64 - BitVec.ofInt 6 (k : Int) := by
  rw [show ((64 : Int) - (k : Int)) = ((64 - k : Nat) : Int) from by omega]
...
theorem ofInt_5_sub (k : Nat) (hk : k ≤ 31) :
    BitVec.ofInt 5 ((32 : Int) - (k : Int)) = 32 - BitVec.ofInt 5 (k : Int) := by
  rw [show ((32 : Int) - (k : Int)) = ((32 - k : Nat) : Int) from by omega]
...
theorem sdivPow2_pos_isRefinedBy {x xt : Data.LLVM.Int 64} (c : Int) (k : Nat)
    ...
    Data.LLVM.Int.sdiv x (Data.LLVM.Int.constant 64 c) false
      ⊒ RISCV.Reg.toInt
          (Data.RISCV.srai (BitVec.ofInt 6 (k : Int))
            (Data.RISCV.add
              (Data.RISCV.srli (BitVec.ofInt 6 ((64 : Int) - (k : Int)))
                (Data.RISCV.srai (BitVec.ofInt 6 ((64 : Int) - 1)) (LLVM.Int.toReg xt)))
  ...
  have h63 : BitVec.ofInt 6 ((64 : Int) - 1) = 63 := by decide
...
theorem sdivwPow2_pos_isRefinedBy {x xt : Data.LLVM.Int 32} (c : Int) (k : Nat)
    ...
    Data.LLVM.Int.sdiv x (Data.LLVM.Int.constant 32 c) false
      ⊒ RISCV.Reg.toInt
          (Data.RISCV.sraiw (BitVec.ofInt 5 (k : Int))
            (Data.RISCV.addw
              (Data.RISCV.srliw (BitVec.ofInt 5 ((32 : Int) - (k : Int)))
                (Data.RISCV.sraiw (BitVec.ofInt 5 ((32 : Int) - 1)) (LLVM.Int.toReg xt)))
  ...
  have h31 : BitVec.ofInt 5 ((32 : Int) - 1) = 31 := by decide
...
theorem sdivPow2_local_preservesSemantics :
  ...
  sdivPow2GenLocal_preservesSemantics
    ...
    (fun _ _ _ _ _ _ => rfl)
    (fun _ _ _ _ _ _ => rfl)
    (fun _ xt c k hm hk0 hx => sdivPow2_pos_isRefinedBy c k hm hk0 hx)
    (fun _ xt c k hm hk0 hx => by
      rw [gen_sub_li_zero_eq_neg]; exact sdivPow2_neg_isRefinedBy c k hm hk0 hx)
...
theorem sdivwPow2_local_preservesSemantics :
  ...
  sdivPow2GenLocal_preservesSemantics
    ...
    (fun _ _ _ _ _ _ => rfl)
    (fun _ _ _ _ _ _ => rfl)
    (fun _ xt c k hm hk0 hx => sdivwPow2_pos_isRefinedBy c k hm hk0 hx)
    (fun _ xt c k hm hk0 hx => by
      rw [gen_subw_li_zero_eq_negw]; exact sdivwPow2_neg_isRefinedBy c k hm hk0 hx)
