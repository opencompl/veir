...
def barretReduceRewriter : LocalRewritePattern OpCode := fun ctx op => do
  ...
  let (ctx, extOp) ← Rewriter.createOp ctx .arith_extui #[interType] #[input] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
  ...
  let (ctx, mulRatioOp) ← Rewriter.createOp ctx .arith_muli #[interType] #[extRes, ratioRes] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
  let (ctx, shiftedOp) ← Rewriter.createOp ctx .arith_shrui #[interType] #[mulRatioOp.getResult 0, shiftRes] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
  let (ctx, mulModOp) ← Rewriter.createOp ctx .arith_muli #[interType] #[shiftedOp.getResult 0, modRes] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
  let (ctx, subOp) ← Rewriter.createOp ctx .arith_subi #[interType] #[extRes, mulModOp.getResult 0] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
  let (ctx, truncOp) ← Rewriter.createOp ctx .arith_trunci #[inputIntType] #[subOp.getResult 0] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
...
def subIfGeRewriter : LocalRewritePattern OpCode := fun ctx op => do
  ...
  let (ctx, subOp) ← Rewriter.createOp ctx .arith_subi #[intType] #[lhs, rhs] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
  let (ctx, cmpOp) ← Rewriter.createOp ctx .arith_cmpi #[cmpType] #[lhs, rhs] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
  let (ctx, selectOp) ← Rewriter.createOp ctx .arith_select #[intType]
    #[cmpOp.getResult 0, subOp.getResult 0, lhs] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
...
def reduceRewriter : LocalRewritePattern OpCode := fun ctx op => do
  ...
  let (ctx', subIfGeOp) ← Rewriter.createOp ctx .mod_arith_subifge #[workIntType]
    #[barrettOp.getResult 0, modulusOp.getResult 0] #[] #[] default none
    (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
  ctx := ctx'
  ...
  | .integerType resultIntType =>
    if resultIntType = workIntType then
      ...
      let (ctx', truncOp) ← Rewriter.createOp ctx .arith_trunci #[resultIntType] #[loweredValue] #[] #[] default none
        (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
      ctx := ctx'
      loweredValue := truncOp.getResult 0
      newOps := newOps.push truncOp
    else
      let (ctx', extOp) ← Rewriter.createOp ctx .arith_extui #[resultIntType] #[loweredValue] #[] #[] default none
        (by sorry) (by sorry) (by sorry) (by sorry) (by sorry)
      ctx := ctx'
...
def barretReduceRewriterPattern : RewritePattern OpCode := Veir.RewritePattern.fromLocalRewrite barretReduceRewriter
def subIfGeRewriterPattern : RewritePattern OpCode := Veir.RewritePattern.fromLocalRewrite subIfGeRewriter
def reduceRewriterPattern : RewritePattern OpCode := Veir.RewritePattern.fromLocalRewrite reduceRewriter
