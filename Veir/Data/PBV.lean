...
* `Veir.Data.PBV.Mask` — step 5: `maskOfWidth`, the mask constraint, translating
                            width relations and arithmetic into mask relations.
* `Veir.Data.PBV.Push` — step 6: pushing `setWidth` from the root to
  its leaves.
