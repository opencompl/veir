...
Instantiation of `RangeDomain` with a integer range lattice whose elements
are `bottom`, `interval`, or `top`.

Currently, this file only adds the lattice structure for range analysis;
