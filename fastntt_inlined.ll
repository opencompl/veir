...
19:                                               ; preds = %89, %16
  %.05 = phi i64 [ %11, %16 ], [ %81, %89 ]
  %.04 = phi i64 [ %17, %16 ], [ %88, %89 ]
  %.03 = phi i64 [ %18, %16 ], [ %74, %89 ]
  %.02 = phi i64 [ 0, %16 ], [ %90, %89 ]
  br label %20

20:                                               ; preds = %22, %19
  %.07 = phi i64 [ 0, %19 ], [ %24, %22 ]
  %.06 = phi i64 [ %1, %19 ], [ %23, %22 ]
  %21 = icmp sgt i64 %.06, 1
