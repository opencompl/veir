#!/usr/bin/env bash
# Compatibility wrapper for the Phase 0 harness gates.
#
...
if [[ "${VEIR_HARNESS_LOCAL_ONLY:-0}" == "1" ]]; then
  ...
  echo "WARN: this is a local layout check, not Phase 0 acceptance evidence."
...
echo
echo "Phase 0 harness gates completed."
