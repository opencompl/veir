...
#guard Dyadic.lower (Dyadic.ofIntWithPrec 3 1) 4 0 = EDyadic.ofDyadic false 1
#guard Dyadic.upper (Dyadic.ofIntWithPrec 3 1) 4 0 = EDyadic.ofDyadic false 2

-- lower/upper of an exactly representable value collapse to the value.
#guard Dyadic.lower (Dyadic.ofIntWithPrec 2 0) 4 0 = EDyadic.ofDyadic false 2
#guard Dyadic.upper (Dyadic.ofIntWithPrec 2 0) 4 0 = EDyadic.ofDyadic false 2

-- lower/upper for negative: lower(-1.5) = -2, upper(-1.5) = -1.
#guard Dyadic.lower (Dyadic.ofIntWithPrec (-3) 1) 4 0 = EDyadic.ofDyadic false (-2)
#guard Dyadic.upper (Dyadic.ofIntWithPrec (-3) 1) 4 0 = EDyadic.ofDyadic false (-1)
