...
theorem bv_AddSub_1156 :
    ∀ (e : Int 64), LLVM.Int.add e e = LLVM.Int.shl e (LLVM.Int.constant (w := 64) 1) := by
  simp [llvm_toBitVec]
  bv_decide
...
theorem bv_AddSub_1614 :
    ∀ (e e_1 : Int 64), LLVM.Int.sub e_1 (LLVM.Int.add e_1 e) = LLVM.Int.sub (LLVM.Int.constant (w := 64) 0) e := by
  simp [llvm_toBitVec]
  bv_decide
