...
"builtin.module"() ({
  ...
  ^bb0(%i: i32, %l: i64):
    ...
    %r = "llvm.insertvalue"(%a, %i) <{position = array<i64: 0, 0>}> : (!llvm.array<2 x i32>, i32) -> !llvm.array<2 x i32>
    "llvm.return"() : () -> ()
  }) : () -> ()
}) : () -> ()

// CHECK: llvm.insertvalue: Expected LLVM IR structure/array type, got: i32
