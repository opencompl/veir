...
"builtin.module"() ({
  ...
  ^bb0(%i: i32, %l: i64):
    ...
    %r = "llvm.insertvalue"(%u, %i) <{position = array<i64: 0>}> : (!llvm.struct<(i32, i64)>, i32) -> !llvm.struct<(i64, i32)>
    "llvm.return"() : () -> ()
  }) : () -> ()
}) : () -> ()

// CHECK: llvm.insertvalue: Expected the result to have the container type
