...
"builtin.module"() ({
  ^bb0():
    ...
    %14 = "riscv.slliw"(%0) <{ "value" = 13 : i32 }> : (i64) -> i64
    %15 = "riscv.srliw"(%0) <{ "value" = 17 : i32 }> : (i64) -> i64
    %16 = "riscv.sraiw"(%0) <{ "value" = 19 : i32 }> : (i64) -> i64
...
// CHECK-NEXT:     %{{.*}} = "riscv.slliw"(%{{.*}}) <{"value" = 13 : i12}> : (i64) -> i64
// CHECK-NEXT:     %{{.*}} = "riscv.srliw"(%{{.*}}) <{"value" = 17 : i12}> : (i64) -> i64
// CHECK-NEXT:     %{{.*}} = "riscv.sraiw"(%{{.*}}) <{"value" = 19 : i12}> : (i64) -> i64
