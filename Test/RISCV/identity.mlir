...
"builtin.module"() ({
  ^bb0():
    ...
    // Immediate load 
    %2 = "riscv.lui"() <{"value" = 13 : i20}> : (i64) -> i64
    %3 = "riscv.auipc"(%0) : (i64) -> i64
    // Immediate operations 
    %4 = "riscv.addi"(%0) : (i64) -> i64
    %{{.*}} = "riscv.slti"(%0) : (i64) -> i64
    %{{.*}} = "riscv.sltiu"(%0) : (i64) -> i64
    ...
    %{{.*}}0 = "riscv.mul"(%0, %1) : (i64, i64) -> i64
    %{{.*}}1 = "riscv.mulh"(%0, %1) : (i64, i64) -> i64
    %{{.*}}2 = "riscv.mulhu"(%0, %1) : (i64, i64) -> i64
    %{{.*}}3 = "riscv.mulhsu"(%0, %1) : (i64, i64) -> i64
    %{{.*}}4 = "riscv.mulw"(%0, %1) : (i64, i64) -> i64
    %{{.*}}5 = "riscv.div"(%0, %1) : (i64, i64) -> i64
    %{{.*}}6 = "riscv.divw"(%0, %1) : (i64, i64) -> i64
    %{{.*}}7 = "riscv.divu"(%0, %1) : (i64, i64) -> i64
    %{{.*}}8 = "riscv.divuw"(%0, %1) : (i64, i64) -> i64
    %{{.*}}9 = "riscv.adduw"(%0, %1) : (i64, i64) -> i64
    %{{.*}}0 = "riscv.sh1adduw"(%0, %1) : (i64, i64) -> i64
    %{{.*}}1 = "riscv.sh2adduw"(%0, %1) : (i64, i64) -> i64
    %{{.*}}2 = "riscv.sh3adduw"(%0, %1) : (i64, i64) -> i64
    %{{.*}}3 = "riscv.sh1add"(%0, %1) : (i64, i64) -> i64
    %{{.*}}4 = "riscv.sh2add"(%0, %1) : (i64, i64) -> i64
    %{{.*}}5 = "riscv.sh3add"(%0, %1) : (i64, i64) -> i64
    %{{.*}}6 = "riscv.andn"(%0, %1) : (i64, i64) -> i64
    %{{.*}}7 = "riscv.orn"(%0, %1) : (i64, i64) -> i64
    %{{.*}}8 = "riscv.xnor"(%0, %1) : (i64, i64) -> i64
    %{{.*}}9 = "riscv.max"(%0, %1) : (i64, i64) -> i64
...
// CHECK-NEXT:     %{{.*}} = "riscv.lui"(%{{.*}}) <{"value" = 13 : i20}> : (i64) -> i64
