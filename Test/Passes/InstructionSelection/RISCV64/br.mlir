...
// CHECK-NEXT:     "riscv_cf.bne"([[CA]], [[CB]], [[CC]]) [^13, ^14] <{"operandSegmentSizes" = array<i0>}> : (!riscv.reg, !riscv.reg, !riscv.reg) -> ()
...
// CHECK-NEXT:     "riscv_cf.bne"([[CA]], [[CB]], [[CC]]) [^21, ^22] <{"operandSegmentSizes" = array<i0>}> : (!riscv.reg, !riscv.reg, !riscv.reg) -> ()
