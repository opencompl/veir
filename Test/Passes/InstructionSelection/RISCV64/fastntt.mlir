...
// CHECK-NEXT:         %[[v368:[0-9]+]] = "riscv.xor"(%[[v376]], %[[varg7_4]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
...
// CHECK-NEXT:       ^[[bb12]]():
// CHECK-NEXT:         "riscv_cf.branch"(%[[varg7_1]]) [^[[bb15:[0-9]+]]] : (!riscv.reg) -> ()
// CHECK-NEXT:       ^[[bb13]]():
// CHECK-NEXT:         "riscv_cf.branch"(%[[v374]]) [^[[bb15]]] : (!riscv.reg) -> ()
// CHECK-NEXT:       ^[[bb15]](%[[varg15_0:[a-zA-Z0-9_]+]] : !riscv.reg):
// CHECK-NEXT:         %[[v362:[0-9]+]] = "riscv.xor"(%[[v376]], %[[varg7_4]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
...
// CHECK-NEXT:       ^[[bb20]]():
// CHECK-NEXT:         %[[v358:[0-9]+]] = "riscv.div"(%[[varg7_5]], %[[v374]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:         "riscv_cf.branch"(%[[v358]]) [^[[bb22]]] : (!riscv.reg) -> ()
// CHECK-NEXT:       ^[[bb22]](%[[varg22_0:[a-zA-Z0-9_]+]] : !riscv.reg):
// CHECK-NEXT:         %[[v354:[0-9]+]] = "riscv.div"(%[[varg7_1]], %[[v374]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
...
// CHECK-NEXT:         "riscv_cf.branch"(%[[v376]], %[[varg7_1]]) [^[[bb29:[0-9]+]]] : (!riscv.reg, !riscv.reg) -> ()
...
// CHECK-NEXT:         %[[v334:[0-9]+]] = "riscv.div"(%[[varg7_1]], %[[varg27_3]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
...
// CHECK-NEXT:         %[[v310:[0-9]+]] = "riscv.sh3add"(%[[v314]], %[[varg7_0]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
...
// CHECK-NEXT:         %[[v295:[0-9]+]] = "riscv.sh3add"(%[[v299]], %[[varg7_0]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
...
// CHECK-NEXT:         %[[v276:[0-9]+]] = "riscv.sh3add"(%[[v280]], %[[varg7_3]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
...
// CHECK-NEXT:         %[[v265:[0-9]+]] = "riscv.rem"(%[[v269]], %[[varg7_2]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:         %[[v261:[0-9]+]] = "riscv.add"(%[[v265]], %[[v306]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:         %[[v257:[0-9]+]] = "riscv.rem"(%[[v261]], %[[varg7_2]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:         %[[v253:[0-9]+]] = "riscv.sub"(%[[v306]], %[[v265]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:         %[[v249:[0-9]+]] = "riscv.add"(%[[varg7_2]], %[[v253]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:         %[[v245:[0-9]+]] = "riscv.rem"(%[[v249]], %[[varg7_2]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:         %[[v241:[0-9]+]] = "riscv.sh3add"(%[[v314]], %[[varg7_0]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
// CHECK-NEXT:         "riscv.sd"(%[[v241]], %[[v257]]) <{"value" = 0 : i64}> : (!riscv.reg, !riscv.reg) -> ()
// CHECK-NEXT:         %[[v234:[0-9]+]] = "riscv.sh3add"(%[[v299]], %[[varg7_0]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
...
// CHECK-NEXT:         %[[v213:[0-9]+]] = "riscv.xor"(%[[v376]], %[[varg7_4]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
...
// CHECK-NEXT:         %[[v199:[0-9]+]] = "riscv.xor"(%[[v376]], %[[varg7_4]]) : (!riscv.reg, !riscv.reg) -> !riscv.reg
