...
// Exercise both constant rotates and both folded memory operations.
"builtin.module"() ({
  "func.func"() <{sym_name = "main", function_type = () -> (i64, i64, i64, i64, i64, i32, i32, i8, i8)}> ({
    ...
    "func.return"(%signed, %boolean, %signed32, %right, %left, %right32, %left32, %stored, %loaded) : (i64, i64, i64, i64, i64, i32, i32, i8, i8) -> ()
  }) : () -> ()
}) : () -> ()

// RESULT: Program output: #[0xffffffffffffffff#64, 0x0000000000000001#64, 0xffffffffffffffff#64, 0x8000000000000000#64, 0x0000000000000002#64, 0x80000000#32, 0x00000002#32, 0x2a#8, 0x2b#8]
