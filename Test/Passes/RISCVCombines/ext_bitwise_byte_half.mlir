...
// CHECK:      func.func @f0(%[[A_X:.*]]: !riscv.reg, %[[A_Y:.*]]: !riscv.reg) -> !riscv.reg {
...
// CHECK:      func.func @f1(%[[O_X:.*]]: !riscv.reg, %[[O_Y:.*]]: !riscv.reg) -> !riscv.reg {
...
// CHECK:      func.func @f2(%[[E_X:.*]]: !riscv.reg, %[[E_Y:.*]]: !riscv.reg) -> !riscv.reg {
...
// CHECK:      func.func @f3(%[[H_X:.*]]: !riscv.reg, %[[H_Y:.*]]: !riscv.reg) -> !riscv.reg {
...
// CHECK:      func.func @f4(%[[NO_X:.*]]: !riscv.reg, %[[NO_Y:.*]]: !riscv.reg) -> !riscv.reg {
...
// CHECK:      func.func @f5(%[[NA_X:.*]]: !riscv.reg, %[[NA_Y:.*]]: !riscv.reg) -> !riscv.reg {
