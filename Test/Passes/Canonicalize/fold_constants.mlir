...
"builtin.module"() ({
  "func.func"() <{function_type = () -> i32, sym_name = "arith_chain"}> ({
    ...
    // CHECK-LABEL: func.func @arith_chain
  ...
  "func.func"() <{function_type = () -> i64, sym_name = "llvm_add"}> ({
    ...
    // CHECK-LABEL: func.func @llvm_add
  ...
  "func.func"() <{function_type = () -> i32, sym_name = "constant_ub"}> ({
    ...
    // CHECK-LABEL: func.func @constant_ub
  ...
  "func.func"() <{function_type = () -> (i8, i8), sym_name = "extended_multiply"}> ({
    ...
    // CHECK-LABEL: func.func @extended_multiply
  ...
  "func.func"() <{function_type = () -> (i8, i8), sym_name = "extended_multiply_overflow"}> ({
    ...
    // CHECK-LABEL: func.func @extended_multiply_overflow() -> (i8, i8)
