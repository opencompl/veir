...
"builtin.module"() ({
  ...
  ^bb0(%dst: !llvm.ptr, %src: !llvm.ptr, %len: i64):
    ...
    // Not type-checked before being dropped, as in MLIR.
    "llvm.intr.memcpy"(%src, %dst, %len) <{isVolatile = false, op_bundle_sizes = "nonsense", op_bundle_tags = 7 : i32}> : (!llvm.ptr, !llvm.ptr, i64) -> ()
    "llvm.return"() : () -> ()
  }) : () -> ()
}) : () -> ()
