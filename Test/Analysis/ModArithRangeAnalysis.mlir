...
// CHECK:      // mod_arith.range block argument 0 = [0, 12288]
// CHECK-NEXT: // mod_arith.range block argument 1 = [0, 12288]
// CHECK-NEXT: // mod_arith.range mod_arith.constant result 0 = [46, 46]
// CHECK-NEXT: // mod_arith.range mod_arith.constant result 0 = [3, 3]
// CHECK-NEXT: // mod_arith.range mod_arith.add result 0 = [0, 12288]
// CHECK-NEXT: // mod_arith.range mod_arith.add result 0 = [0, 12288]
// CHECK-NEXT: // mod_arith.range mod_arith.add result 0 = [0, 12288]
// CHECK-NEXT: // mod_arith.range mod_arith.mul result 0 = [0, 12288]
...
// CHECK-NEXT: // mod_arith.range block argument 0 = [0, 12288]
// CHECK-NEXT: // mod_arith.range block argument 1 = [0, 12288]
// CHECK-NEXT: // mod_arith.range mod_arith.constant result 0 = [46, 46]
// CHECK-NEXT: // mod_arith.range mod_arith.constant result 0 = [3, 3]
// CHECK-NEXT: // mod_arith.range mod_arith.add result 0 = [46, 12334]
// CHECK-NEXT: // mod_arith.range mod_arith.add result 0 = [46, 24622]
// CHECK-NEXT: // mod_arith.range mod_arith.add result 0 = [46, 36910]
// CHECK-NEXT: // mod_arith.range mod_arith.mul result 0 = [138, 110730]
...
// CHECK-NEXT: // mod_arith.range block argument 0 = [0, 250]
// CHECK-NEXT: // mod_arith.range block argument 1 = [0, 250]
// CHECK-NEXT: // mod_arith.range mod_arith.add result 0 = [0, 500]
// CHECK-NEXT: // mod_arith.range mod_arith.mul result 0 = [0, 62500]
...
// CHECK-NEXT: // mod_arith.range block argument 0 = [0, 16]
// CHECK-NEXT: // mod_arith.range block argument 1 = [0, 16]
// CHECK-NEXT: // mod_arith.range mod_arith.sub result 0 = [0, 16]
// CHECK-NEXT: // mod_arith.range mod_arith.sub result 0 = [1, 33]
// CHECK-NEXT: // mod_arith.range test.test result 0 = top
...
// CHECK-NEXT: // mod_arith.range mod_arith.constant result 0 = [2, 2]
// CHECK-NEXT: // mod_arith.range mod_arith.constant result 0 = [7, 7]
// CHECK-NEXT: // mod_arith.range block argument 0 = [2, 2]
// CHECK-NEXT: // mod_arith.range block argument 0 = [7, 7]
// CHECK-NEXT: // mod_arith.range block argument 0 = [2, 7]
// CHECK-NEXT: // mod_arith.range mod_arith.constant result 0 = [3, 3]
// CHECK-NEXT: // mod_arith.range mod_arith.add result 0 = [5, 10]
