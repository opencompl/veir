...
"builtin.module"() ({
  ...
  "func.func"() <{sym_name = "main", function_type = (!riscv.reg) -> !riscv.reg}> ({
    ...
    ^entry(%s0 : !riscv.reg):
      ...
      "riscv.sw"(%s0, %e_a0) <{"value" = -20 : i64}> : (!riscv.reg, !riscv.reg) -> ()        // sw a0, -20(s0)
      "riscv.sw"(%s0, %e_a0) <{"value" = -24 : i64}> : (!riscv.reg, !riscv.reg) -> ()        // sw a0, -24(s0)
      %e_a1 = "riscv.li"() <{"value" = 2 : i64}> : () -> !riscv.reg                          // li a1, 2
      "riscv.sw"(%s0, %e_a1) <{"value" = -28 : i64}> : (!riscv.reg, !riscv.reg) -> ()        // sw a1, -28(s0)
      "riscv.sw"(%s0, %e_a0) <{"value" = -32 : i64}> : (!riscv.reg, !riscv.reg) -> ()        // sw a0, -32(s0)
      "riscv_cf.branch"(%s0) [^bb1] : (!riscv.reg) -> ()                                     // j .LBB0_1

    // .LBB0_1: while.cond
    ^bb1(%b1_s0 : !riscv.reg):
      %b1_a1 = "riscv.lw"(%b1_s0) <{"value" = -24 : i64}> : (!riscv.reg) -> !riscv.reg       // lw a1, -24(s0)
    ...
    ^bb2(%b2_s0 : !riscv.reg):
      ...
      "riscv.sw"(%b2_s0, %b2_a0) <{"value" = -36 : i64}> : (!riscv.reg, !riscv.reg) -> ()     // sw a0, -36(s0)
      %b2_a0b = "riscv.li"() <{"value" = 2 : i64}> : () -> !riscv.reg                         // li a0, 2
      "riscv.sw"(%b2_s0, %b2_a0b) <{"value" = -40 : i64}> : (!riscv.reg, !riscv.reg) -> ()    // sw a0, -40(s0)
      "riscv_cf.branch"(%b2_s0) [^bb3] : (!riscv.reg) -> ()                                   // j .LBB0_3

    // .LBB0_3: for.cond
    ^bb3(%b3_s0 : !riscv.reg):
      %b3_a0 = "riscv.lw"(%b3_s0) <{"value" = -40 : i64}> : (!riscv.reg) -> !riscv.reg        // lw a0, -40(s0)
      %b3_a1 = "riscv.mulw"(%b3_a0, %b3_a0) : (!riscv.reg, !riscv.reg) -> !riscv.reg          // mulw a1, a0, a0
      %b3_a0b = "riscv.lw"(%b3_s0) <{"value" = -28 : i64}> : (!riscv.reg) -> !riscv.reg       // lw a0, -28(s0)
    ...
    // .LBB0_4: for.body
    ^bb4(%b4_s0 : !riscv.reg):
      %b4_a0 = "riscv.lw"(%b4_s0) <{"value" = -28 : i64}> : (!riscv.reg) -> !riscv.reg        // lw a0, -28(s0)
      %b4_a1 = "riscv.lw"(%b4_s0) <{"value" = -40 : i64}> : (!riscv.reg) -> !riscv.reg        // lw a1, -40(s0)
    ...
    ^bb5(%b5_s0 : !riscv.reg):
      ...
      "riscv.sw"(%b5_s0, %b5_a0) <{"value" = -36 : i64}> : (!riscv.reg, !riscv.reg) -> ()     // sw a0, -36(s0)
    ...
    // .LBB0_7: for.inc
    ^bb7(%b7_s0 : !riscv.reg):
      %b7_a0 = "riscv.lw"(%b7_s0) <{"value" = -40 : i64}> : (!riscv.reg) -> !riscv.reg        // lw a0, -40(s0)
      %b7_a0n = "riscv.addiw"(%b7_a0) <{"value" = 1 : i64}> : (!riscv.reg) -> !riscv.reg      // addiw a0, a0, 1
      "riscv.sw"(%b7_s0, %b7_a0n) <{"value" = -40 : i64}> : (!riscv.reg, !riscv.reg) -> ()    // sw a0, -40(s0)
      "riscv_cf.branch"(%b7_s0) [^bb3] : (!riscv.reg) -> ()                                   // j .LBB0_3

    // .LBB0_8: for.end
    ^bb8(%b8_s0 : !riscv.reg):
      %b8_a0 = "riscv.lw"(%b8_s0) <{"value" = -36 : i64}> : (!riscv.reg) -> !riscv.reg        // lw a0, -36(s0)
    ...
    // .LBB0_9: if.then3
    ^bb9(%b9_s0 : !riscv.reg):
      %b9_a0 = "riscv.lw"(%b9_s0) <{"value" = -28 : i64}> : (!riscv.reg) -> !riscv.reg        // lw a0, -28(s0)
      "riscv.sw"(%b9_s0, %b9_a0) <{"value" = -32 : i64}> : (!riscv.reg, !riscv.reg) -> ()     // sw a0, -32(s0)
      %b9_a0b = "riscv.lw"(%b9_s0) <{"value" = -24 : i64}> : (!riscv.reg) -> !riscv.reg       // lw a0, -24(s0)
      %b9_a0n = "riscv.addiw"(%b9_a0b) <{"value" = 1 : i64}> : (!riscv.reg) -> !riscv.reg     // addiw a0, a0, 1
      "riscv.sw"(%b9_s0, %b9_a0n) <{"value" = -24 : i64}> : (!riscv.reg, !riscv.reg) -> ()    // sw a0, -24(s0)
      "riscv_cf.branch"(%b9_s0) [^bb10] : (!riscv.reg) -> ()                                  // j .LBB0_10

    // .LBB0_10: if.end5
    ^bb10(%b10_s0 : !riscv.reg):
      %b10_a0 = "riscv.lw"(%b10_s0) <{"value" = -28 : i64}> : (!riscv.reg) -> !riscv.reg      // lw a0, -28(s0)
      %b10_a0n = "riscv.addiw"(%b10_a0) <{"value" = 1 : i64}> : (!riscv.reg) -> !riscv.reg    // addiw a0, a0, 1
      "riscv.sw"(%b10_s0, %b10_a0n) <{"value" = -28 : i64}> : (!riscv.reg, !riscv.reg) -> ()  // sw a0, -28(s0)
      "riscv_cf.branch"(%b10_s0) [^bb1] : (!riscv.reg) -> ()                                  // j .LBB0_1

    // .LBB0_11: while.end
    ^bb11(%b11_s0 : !riscv.reg):
      %b11_a0 = "riscv.lw"(%b11_s0) <{"value" = -32 : i64}> : (!riscv.reg) -> !riscv.reg      // lw a0, -32(s0)
