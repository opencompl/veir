...
// `ptrtoint` yields the physical address and `inttoptr` finds the object at
// an address again, including at an offset into it.
...
// CHECK: Program output: #[0x00000013#32]
